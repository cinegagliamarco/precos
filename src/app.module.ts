...
@Module({
  ...
  providers: [
    ImportBaseProductsUseCase,
    ImportProductsDrogalUseCase,
    ImportProductsDrogasilUseCase,
    ImportGenericProductsUseCase,
    ExportProductsUseCase,
    ExportGenericProductsUseCase,
    ImportDrogalStockUseCase
  ]
})
